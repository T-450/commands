# Configuration Validation Tool - GitHub Copilot Instructions
## Overview
Validate configuration files, environment variables, and infrastructure-as-code for correctness, security, and best practices.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Validate Kubernetes manifests"
- "Check Terraform configuration for errors"
