# Security Scan Tool - GitHub Copilot Instructions
## Overview
Comprehensive security vulnerability scanning across code, dependencies, containers, and infrastructure with remediation guidance.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Run security scan on this codebase"
