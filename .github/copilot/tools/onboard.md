# Developer Onboarding Tool - GitHub Copilot Instructions
## Overview
Generate comprehensive onboarding materials for new developers including setup guides, architecture overview, and first tasks.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Create onboarding guide for new developers"
- "Generate project introduction and setup docs"
- "Build developer onboarding checklist"
...
- `context-restore.md` - Context Restore
