# Error Analysis Tool - GitHub Copilot Instructions
## Overview
Analyze error patterns, root causes, and trends from logs and monitoring data with actionable insights.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Analyze error patterns in logs"
- "Find root cause of recurring errors"
- "Identify error trends and correlations"
