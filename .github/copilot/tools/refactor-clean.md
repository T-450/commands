# Code Refactoring Tool - GitHub Copilot Instructions
## Overview
Refactor code for improved maintainability, performance, and design patterns while preserving functionality.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Refactor this code for better maintainability"
- "Clean up code smells and technical debt"
