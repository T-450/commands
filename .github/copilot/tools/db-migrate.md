# Database Migration Tool - GitHub Copilot Instructions
## Overview
Create and manage database migrations with schema changes, data transformations, rollback support, and zero-downtime strategies.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Create database migration for schema changes"
- "Generate migration to add new table"
