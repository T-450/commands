# API Mock Generation Tool - GitHub Copilot Instructions
## Overview
Generate comprehensive API mocks and stubs for testing, development, and integration scenarios with realistic data and edge cases.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Generate API mocks for this OpenAPI spec"
- "Create test doubles for external services"
- "Build mock server with realistic responses"
- "Generate stub implementations for this API"
