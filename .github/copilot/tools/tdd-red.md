# TDD Red Phase Tool - GitHub Copilot Instructions
## Overview
Write failing tests first in the TDD red phase, defining expected behavior before implementation.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Write failing tests for this feature"
- "Create TDD red phase tests"
