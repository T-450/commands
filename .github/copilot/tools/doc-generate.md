# Documentation Generation Tool - GitHub Copilot Instructions
## Overview
Generate comprehensive documentation including API docs, architecture diagrams, user guides, and inline comments.
...
- "Build user guide for this feature"
