# Compliance Validation Tool - GitHub Copilot Instructions
## Overview
Validate code and infrastructure against regulatory standards (GDPR, HIPAA, SOC 2, PCI-DSS) and security frameworks.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Check GDPR compliance for user data handling"
- "Validate HIPAA requirements in this application"
- "Audit SOC 2 compliance for security controls"
