# Dependency Upgrade Tool - GitHub Copilot Instructions
## Overview
Safely upgrade dependencies with compatibility checking, breaking change analysis, and automated testing.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Upgrade dependencies to latest versions"
- "Update npm packages safely"
- "Migrate to new major version of library"
- "Upgrade Python dependencies with compatibility check"
...
### Tools
- `deps-audit.md` - Deps Audit
- `code-migrate.md` - Code Migrate
