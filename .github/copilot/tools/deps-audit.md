# Dependency Audit Tool - GitHub Copilot Instructions
## Overview
Audit dependencies for security vulnerabilities, license compliance, and version conflicts with automated remediation.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Audit dependencies for vulnerabilities"
- "Check npm/pip packages for security issues"
- "Validate license compliance in dependencies"
- "Scan for outdated packages with CVEs"
