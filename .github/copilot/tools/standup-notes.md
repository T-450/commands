# Standup Notes Generator Tool - GitHub Copilot Instructions
## Overview
Generate daily standup notes from git commits, issue activity, and code changes with accomplishments and blockers.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Generate standup notes from my recent work"
- "Create status update from git commits"
- "Build daily standup summary"
- "Generate progress report for team"
...
### Tools
- `context-save.md` - Context Save
- `pr-enhance.md` - Pr Enhance
- `onboard.md` - Onboard
