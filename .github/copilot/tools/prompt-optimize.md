# Prompt Optimization Tool - GitHub Copilot Instructions
## Overview
Optimize prompts for LLMs to improve quality, reduce tokens, and enhance reliability with testing and iteration.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Optimize this LLM prompt for better results"
- "Reduce token count while maintaining quality"
- "Improve prompt engineering for this task"
