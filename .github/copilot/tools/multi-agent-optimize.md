# Multi-Agent Optimization Tool - GitHub Copilot Instructions
## Overview
Optimize code using multiple specialized AI agents working in parallel for comprehensive improvements.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Optimize this code using multiple agents"
- "Run parallel optimization with specialized agents"
- "Apply multi-perspective optimization"
- "Use agent swarm for code improvement"
...
### Tools
- `multi-agent-review.md` - Multi Agent Review
- `refactor-clean.md` - Refactor Clean
- `cost-optimize.md` - Cost Optimize
