# Accessibility Audit Tool - GitHub Copilot Instructions
## Overview
Comprehensive accessibility testing and compliance validation following WCAG 2.1 AA/AAA standards, Section 508, and ADA requirements.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Run accessibility audit on this component"
- "Check WCAG 2.1 AA compliance for this page"
