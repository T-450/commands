# SLO Implementation Tool - GitHub Copilot Instructions
## Overview
Define and implement Service Level Objectives with monitoring, alerting, error budgets, and SLA tracking.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Implement SLOs for this service"
- "Create SLA monitoring and alerting"
- "Define error budgets and burn rate alerts"
- "Set up SLI tracking and dashboards"
