# TDD Green Phase Tool - GitHub Copilot Instructions
## Overview
Implement minimal code to make failing tests pass in the TDD green phase, focusing on simplicity.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Make these tests pass with minimal code"
- "Implement green phase for TDD"
- "Write simplest code to pass tests"
- "Complete TDD green step"
