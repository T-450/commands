# Cost Optimization Tool - GitHub Copilot Instructions
## Overview
Analyze and optimize cloud infrastructure, database, and application costs with actionable recommendations and ROI analysis.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Analyze AWS costs and suggest optimizations"
- "Optimize database query costs"
- "Review cloud infrastructure for cost savings"
- "Identify expensive operations in this code"
...
- `docker-optimize.md` - Docker Optimize
- `k8s-manifest.md` - K8S Manifest
