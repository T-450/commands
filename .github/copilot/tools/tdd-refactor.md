# TDD Refactor Phase Tool - GitHub Copilot Instructions
## Overview
Refactor working code while maintaining passing tests in the TDD refactor phase, improving design without changing behavior.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Refactor this code while keeping tests green"
- "Improve design in TDD refactor phase"
- "Clean up code without breaking tests"
- "Apply refactoring patterns to passing code"
