# Monitoring Setup Tool - GitHub Copilot Instructions
## Overview
Set up comprehensive monitoring with metrics, logging, tracing, alerting, and dashboards for production systems.
