# Smart Debugging Tool - GitHub Copilot Instructions
## Overview
Intelligent debugging using AI to analyze errors, suggest fixes, and guide troubleshooting process.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Debug this error using AI analysis"
- "Find root cause of this bug"
- "Suggest fixes for this issue"
- "Guide me through debugging this problem"
