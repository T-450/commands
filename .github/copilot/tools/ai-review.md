# AI/ML Code Review Tool - GitHub Copilot Instructions
## Overview
Specialized code review for AI/ML projects focusing on model quality, reproducibility, data handling, and production readiness.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Review this ML code for best practices"
- "Check AI model code for data leakage"
- "Audit LLM integration for security issues"
- "Review prompt engineering and token management"
