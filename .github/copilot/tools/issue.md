# GitHub Issue Resolution Tool - GitHub Copilot Instructions
## Overview
Analyze, plan, and resolve GitHub issues with automated testing, code changes, and pull request creation.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Fix GitHub issue #123"
- "Resolve bug reported in issue"
