# Test Harness Generation Tool - GitHub Copilot Instructions
## Overview
Generate comprehensive test harnesses with unit, integration, and e2e tests using best practices and modern frameworks.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Generate test harness for this module"
- "Create comprehensive test suite"
- "Build integration tests for API"
- "Generate e2e tests for this workflow"
