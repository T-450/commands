# Code Explanation Tool - GitHub Copilot Instructions
## Overview
Generate comprehensive explanations of code functionality, architecture, and patterns for documentation and onboarding purposes.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Explain how this code works"
- "Generate architecture documentation for this module"
- "Create explanation for new developers"
