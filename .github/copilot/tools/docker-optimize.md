# Docker Optimization Tool - GitHub Copilot Instructions
## Overview
Optimize Docker images and containers for size, security, build speed, and runtime performance.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Optimize this Dockerfile for size"
- "Improve Docker build performance"
- "Secure Docker image following best practices"
