# Pull Request Enhancement Tool - GitHub Copilot Instructions
## Overview
Enhance pull requests with comprehensive descriptions, test coverage analysis, security checks, and review guidance.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Enhance this PR with detailed description"
- "Generate PR summary and testing notes"
- "Add PR checklist and review guidance"
- "Improve PR with context and documentation"
