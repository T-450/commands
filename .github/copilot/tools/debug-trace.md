# Debug Tracing Tool - GitHub Copilot Instructions
## Overview
Add comprehensive debugging instrumentation with structured logging, distributed tracing, and performance profiling.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Add debug tracing to this module"
