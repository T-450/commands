# Deployment Checklist Tool - GitHub Copilot Instructions
## Overview
Generate comprehensive pre-deployment checklist covering testing, security, performance, monitoring, and rollback procedures.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Create deployment checklist for this release"
- "Generate pre-production validation steps"
- "Build deployment runbook with rollback plan"
...
### Tools
- `slo-implement.md` - Slo Implement
