# Context Saving Tool - GitHub Copilot Instructions
## Overview
Save current development context including code state, decisions, and progress for later restoration or handoff.
...
- "Export context for team handoff"
