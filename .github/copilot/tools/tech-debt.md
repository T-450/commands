# Technical Debt Analysis Tool - GitHub Copilot Instructions
## Overview
Identify, prioritize, and create actionable plans to address technical debt with ROI analysis.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Analyze technical debt in this codebase"
- "Create plan to address tech debt"
