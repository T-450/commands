# Error Tracing Tool - GitHub Copilot Instructions
## Overview
Implement comprehensive error tracking with context capture, distributed tracing, and alerting integration.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Add error tracing to this application"
- "Implement error tracking with Sentry"
- "Create structured error logging"
- "Add distributed error tracing"
