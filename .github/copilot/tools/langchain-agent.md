# LangChain Agent Builder Tool - GitHub Copilot Instructions
## Overview
Build intelligent agents using LangChain with tools, memory, and orchestration for complex AI workflows.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Create LangChain agent for data analysis"
- "Build multi-tool agent with memory"
- "Implement autonomous agent workflow"
