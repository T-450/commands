# Kubernetes Manifest Generation Tool - GitHub Copilot Instructions
## Overview
Generate production-ready Kubernetes manifests with best practices for security, scaling, monitoring, and high availability.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Generate Kubernetes manifests for this app"
- "Create K8s deployment with best practices"
- "Build Helm chart for microservice"
- "Generate production-ready K8s configuration"
