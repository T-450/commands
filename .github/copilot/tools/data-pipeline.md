# Data Pipeline Design Tool - GitHub Copilot Instructions
## Overview
Design and implement scalable data pipelines with ingestion, transformation, orchestration, and quality validation.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Design data pipeline for ETL workflow"
- "Create streaming pipeline with Kafka"
- "Build batch processing pipeline with Airflow"
