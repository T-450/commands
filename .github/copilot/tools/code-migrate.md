# Code Migration Tool - GitHub Copilot Instructions
## Overview
Migrate code between languages, frameworks, or versions with automated transformation, testing, and validation.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Migrate this code from Python 2 to Python 3"
- "Convert JavaScript to TypeScript"
- "Upgrade React class components to hooks"
