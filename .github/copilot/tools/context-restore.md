# Context Restoration Tool - GitHub Copilot Instructions
## Overview
Restore development context from saved state including code, decisions, and progress for seamless continuation of work.
