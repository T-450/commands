# AI Assistant Integration Tool - GitHub Copilot Instructions
## Overview
Integrate AI capabilities (LLMs, embeddings, vector databases) into applications with best practices for security, performance, and reliability.

## When to Use
Ask GitHub Copilot to use this pattern when:
- "Add AI assistant to this application"
- "Integrate OpenAI/Anthropic API with best practices"
- "Implement RAG pipeline with vector database"
- "Create AI chat interface with streaming"
...
### Tools
- `langchain-agent.md` - Langchain Agent
- `prompt-optimize.md` - Prompt Optimize
