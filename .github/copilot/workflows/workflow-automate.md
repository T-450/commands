# Workflow Automation - GitHub Copilot Instructions

## Overview

This comprehensive workflow helps you design and implement automation for CI/CD pipelines, GitHub Actions workflows, development processes, and operational tasks. It reduces manual work, improves consistency, and accelerates delivery while maintaining quality and security standards.

## When to Use

**Prompt GitHub Copilot with:**
- "Automate CI/CD pipeline for Node.js application with testing and deployment"
- "Create GitHub Actions workflow for multi-environment deployment"
- "Automate development environment setup and dependency management"
- "Build automated release process with semantic versioning"
- "Set up infrastructure automation with Terraform and Kubernetes"

## Requirements

Describe your automation needs including:
...
"Analyze my project to identify automation opportunities. Review existing workflows, manual processes, build steps, testing procedures, and deployment processes. Provide recommendations for automation."

**Workflow Discovery Script**

Copilot can help you create analysis scripts like this:
...
**Prompt GitHub Copilot:**
"Create comprehensive GitHub Actions CI/CD pipeline with code quality checks, multi-platform testing, build process, Docker image creation, security scanning, and multi-environment deployment to staging and production."
...
**Prompt GitHub Copilot:**
"Create automated release workflow using semantic versioning. Include automatic version bumping, changelog generation, npm/Docker publishing, and GitHub release creation."
...
**Prompt GitHub Copilot:**
"Set up pre-commit hooks for code formatting, linting, security checks, and tests. Include hooks for Python, JavaScript, and Git best practices."
...
**Prompt GitHub Copilot:**
"Create automated development environment setup script that checks prerequisites, installs dependencies, sets up local services with Docker, initializes database, and configures environment variables."
...
**Prompt GitHub Copilot:**
"Create GitHub Actions workflow for Terraform that validates, plans, and applies infrastructure changes with proper state management, PR comments, and approval gates."
...
## Phase 6: Monitoring and Alerting Automation

### Monitoring Stack Deployment

**Prompt GitHub Copilot:**
"Automate deployment of monitoring stack with Prometheus, Grafana, and Alertmanager on Kubernetes using Helm. Include custom dashboards and alert rules."
...
## Phase 7: Dependency Update Automation

### Renovate Configuration

**Prompt GitHub Copilot:**
"Configure Renovate bot for automated dependency updates with automerge for minor updates, security vulnerability alerts, and grouped updates for related packages."
...
**Prompt GitHub Copilot:**
"Automate documentation generation from code comments, TypeScript types, API endpoints, and Markdown files. Deploy to GitHub Pages with versioning."
...
**Prompt GitHub Copilot:**
"Create comprehensive security scanning workflow with Trivy, Snyk, OWASP Dependency Check, SonarCloud, Semgrep, and GitLeaks. Run on push, PR, and weekly schedule."
...
**Prompt GitHub Copilot:**
"Create a workflow orchestration system that handles parallel and sequential steps, retries, timeouts, error handling, and provides visibility into workflow execution."
...
When implementing workflow automation, GitHub Copilot will provide:
...
8. **Workflow Orchestration**: Complex workflow management code
...
- **Parallel When Possible**: Run independent tasks in parallel
- **Comprehensive Logging**: Log everything for debugging
- **Security First**: Include security scanning in all workflows
- **Test Automation**: Thoroughly test your automation
- **Documentation**: Document all workflows and processes
- **Monitoring**: Monitor automation execution and failures
- **Incremental Rollout**: Test changes in non-production first
- **Version Control**: Keep all automation in version control

## Related Patterns

- `ci-cd-setup.md` (tool) - Basic CI/CD setup
- `deploy-checklist.md` (tool) - Deployment verification
- `docker-optimize.md` (tool) - Container optimization
- `k8s-manifest.md` (tool) - Kubernetes manifests
- `monitor-setup.md` (tool) - Monitoring configuration
- `security-scan.md` (tool) - Security scanning
- `incident-response.md` - Handle automation failures
- `infrastructure-as-code.md` (tool) - IaC best practices
